...
def mse_loss(y_true, y_pred):
    ...
    return np.mean((y_true - y_pred) ** 2) # TODO: implement the mean squared error loss
...
class NeuralNetworkClassifier(BaseClassifier):
    ...
    def __init__(self, learning_rate=0.01,
                 max_epoch=85):  # TODO: Update these default parameters, after parameter-tuning.
        super().__init__()
    ...
    def fit(self, X, y):
        ...
        for epoch in range(self.max_epoch):
            for x, y_true in zip(X, y):
                ...
                d_L_d_y_pred = -(y_true - y_pred)  # TODO: the gradient of squared error loss w.r.t. y_pred
                d_y_pred_d_w5 = y_pred * (1 - y_pred)  # TODO: the gradient of y_pred w.r.t. w5
                d_y_pred_d_w6 = y_pred * (1 - y_pred)  # TODO: the gradient of y_pred w.r.t. w6
                d_y_pred_d_b3 = y_pred * (1 - y_pred)  # TODO: the gradient of y_pred w.r.t. b3
                d_y_pred_d_h1 = self.w5 * d_y_pred_d_w5 * h1 * (1 - h1)  # TODO: the gradient of y_pred w.r.t. h1
                d_y_pred_d_h2 = self.w6 * d_y_pred_d_w6 * h2 * (1 - h2)  # TODO: the gradient of y_pred w.r.t. h2

                # Gradients for hidden layer parameters
                d_h1_d_w1 = x[0] * (1 - h1) * h1  # TODO: the gradient of h1 w.r.t. w1
                d_h1_d_w2 = x[1] * (1 - h1) * h1  # TODO: the gradient of h1 w.r.t. w2
                d_h1_d_b1 = (1 - h1) * h1  # TODO: the gradient of h1 w.r.t. b1
                d_h2_d_w3 = x[0] * (1 - h2) * h2  # TODO: the gradient of h2 w.r.t. w3
                d_h2_d_w4 = x[1] * (1 - h2) * h2  # TODO: the gradient of h2 w.r.t. w4
                d_h2_d_b2 = (1 - h2) * h2  # TODO: the gradient of h2 w.r.t. b2
