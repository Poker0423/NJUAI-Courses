...
public class Agent extends AbstractPlayer {
    ...
    int searchDepth = 28;                                                            //限制A*算法的搜索深度，当地图较大时也能得出结果
    /*
    ...
    */
    ...
    private boolean pastEqualTest(StateObservation state) {
    ...
    private void getAStarActions(StateObservation stateObs, ElapsedCpuTimer elapsedTimer){
